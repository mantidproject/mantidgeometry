...
comment = """ This is the instrument definition file of the D33 Massive dynamic q-range small-angle diffractometer
       ...
       This file was automatically generated by mantidgeometry/D33_geometry.py
       ...
       Detector 1 (rear):
       Single panel mono-block size 640 mm x 640 mm
       Pixel size 5 x 5 mm^2 ( 128 x 128 pixels )
       Detector 2 (front):
       4-panel mono-block, size 160 mm x 640 mm per panel
...
d33.addComment("LEFT")
d33.addComponentRectangularDetector(detector2, -dF-dR, 0., zFront, idstart=id2, idfillbyfirst=FF,
                                    idstepbyrow=SR, rotz=90.)
...
d33.addComment("TOP")
d33.addComponentRectangularDetector(detector4, 0., dF+dR, zFront, idstart=id4, idfillbyfirst=FF, idstepbyrow=SR)
...
d33.writeGeom(instrumentName + "_Definition.xml")
