#!/usr/bin/python
# change to the directory of this file and run it on command line with python figaro_generateIDF.py
import sys
# user dependent path
...
comment = """ This is the instrument definition file of the figaro reflectometer at the ILL.
       ...
       This file was automatically generated by geometry_description/mandidgeometry/ILL/IDF/figaro_generatorIDF.py
...
figaro.addComment("64 TUBES FORM ONE BANK")  # bank can be renamed to detector
# this is like for D17, but Figaro has vertical tubes -> is the instrument correct of idfillbyfirst is x?
figaro.addComponentRectangularDetector("bank", 0.0, 0.0, detValue, idstart="2", idfillbyfirst="x",
                                    idstepbyrow="1")
figaro.addComment("PIXEL, EACH PIXEL IS A DETECTOR")
figaro.addRectangularDetector("bank", "pixel", xstart, xstep, xpixels, ystart, ystep, ypixels)
figaro.addCuboidPixel("pixel", [-x, -y, z], [x, y, z], [-x, -y, thickness], [x, -y, z], shape_id="pixel-shape")
figaro.showGeom()
# write instrument definition to file
figaro.writeGeom(xml_outfile)