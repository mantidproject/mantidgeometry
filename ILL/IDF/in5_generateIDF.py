...
cd  ~/git/mantidgeometry/ILL/IDF; python in5_generateIDF.py | tidy -utf8 -xml -w 255 -i -c -q -asxml > ~/git/Mantid/Code/Mantid/instrument/IN5_Definition.xml; rm  ~/git/Mantid/Code/Mantid/instrument/IN5_Definition.vtp 
