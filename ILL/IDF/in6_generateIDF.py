...
cd /home/leal/git/mantidgeometry/ILL/IDF ; python in6_generateIDF.py | tidy -utf8 -xml -w 255 -i -c -q -asxml > ~/git/Mantid/Code/Mantid/instrument/IN6_Definition.xml 
