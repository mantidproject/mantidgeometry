...
nCellsPerPlate = 32
nPlates = 48
nDetectors = nCellsPerPlate * nPlates
firstDetectorId = 1
radius = 1.471 # meters
cellHeight = 0.15 # meters
cellWidth = 0.002568 # meters
cellDepth = 0.0001 # meters # guess
starting2Theta = 1.6
panel2Theta = 3.2
...
def printHeader():
    ...
    valid-to="2100-01-31 23:59:59" last-modified="%s">""" % (
    instrumentName, time.strftime("%Y-%m-%d %H:%M:%S", time.gmtime()))
...
def printDetector():
    ...
    <!-- Detector Panels -->
    <type name="detector">
      <component type="panel">""".format(nDetectors)
