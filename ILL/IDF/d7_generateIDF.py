...
rSampleDetectors = 1.5177 # distance from the sample of even detectors, indices start from 0 (even)
minTwoTheta = 0
maxTwoTheta = 136
...
d7.addDetectorIds("bank2_ids", [0,43,1]) 
d7.addDetectorIds("bank3_ids", [44,87,1]) 
d7.addDetectorIds("bank4_ids", [88,131,1]) 
...
for j in range(numberDetectors):
    ...
    detectorName = "pixel_%d" % (j+1) # pixel indices start from 1, while detector IDs start from 0
